...
export function stravaMe(req, res) {
  return strava.athlete.get({},function(err,payload,limits) {
    if(!err) {
      console.log(payload);
...
// Gets a list of Projects
export function stravaRoute(req, res) {
  return strava.athlete.listRoutes({},function(err,payload,limits) {
    if(!err) {
      console.log(payload);
      res.status(200).json(payload);
    }
